                ...
                case 1:
                    ...
                    if (flow.equals("add")) {
                        ...
                        out.print("<br><div align='center'><form action='addSubject' method='post'><table cellspacing='10'>"
                                + "<tr><td class=\"editSubjectStyle\">Subject Code</td><td> : </td><td><input type='text' id='subid' onkeyup='checkValidations(3)' onchange='checkValidations(3)' name='subjectID' class=\"editSubjectForm\" pattern='^BCA\\d\\d\\d\\d$' minlength='7' maxlength='9' placeholder='BCAxxxx'/></td></tr>"
                                ...
                                + "<tr><td class=\"editSubjectStyle\">Subject Abbreviation</td><td> : </td><td align=''><input type='text' name='abbr' class=\"editSubjectForm\" placeholder='AI' minlength='2' maxlength='3'/> </td></tr>"
