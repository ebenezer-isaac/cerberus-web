    ...
    <body>
        <div class="container" >
            <div class="reset_page" >
                <div class="form_reset" style=" -webkit-touch-callout: none;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;">
                    <div align="center">
