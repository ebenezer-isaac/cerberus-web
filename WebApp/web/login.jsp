    ...
    <div class="col-lg-6 my-auto">
        <div class="main_content mx-auto">
            <a href="about.html" target="_blank" class="text-white abt">
                <div data-tilt >  
                    <img src="images/logomain.png" style="width: 101px; height: 101px; margin-bottom: 70px; pointer-events: none;" /></div>
                <svg width="275" height="40" viewBox="0 0 340 30" fill="none" id="logo" style="pointer-events: none;">
